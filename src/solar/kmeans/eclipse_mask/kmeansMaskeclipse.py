...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="./output_figures_occulted", # Directorio diferente por defecto
                        help="Output directory for figures.")
    parser.add_argument("--file_type", type=str, default="jp2", choices=['fits', 'jp2'], # JP2 por defecto ahora
    ...
    parser.add_argument("--contamination", type=float, default=0.05, # Puede necesitar ajuste para off-limb
    ...
    for anomaly_threshold in args.anomaly_thresholds:
        ...
        anomaly_percentage = (anomaly_pixels_count / total_valid_pixels_resized) * 100 if total_valid_pixels_resized > 0 else 0
        ...
        full_indices = np.arange(args.image_size * args.image_size)
