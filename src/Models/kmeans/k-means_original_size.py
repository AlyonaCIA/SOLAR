...
def main():
    ...
    masked_data_list = []
    channel_names = []
    image_size_for_processing = None if args.no_resize else args.image_size # Determine size, None if no_resize
    ...
    valid_pixel_mask_2d_reshaped = valid_pixel_mask.reshape((final_image_size, final_image_size)) # Use final image size
