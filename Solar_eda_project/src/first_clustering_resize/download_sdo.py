#!/usr/bin/env python
"""This script downloads 30 minutes of SDO/AIA data for multiple EUV channels (94, 131,
171, 193, 211, 304, and 335 Å) from a quiet period (e.g., April 1, 2019, 00:00–00:30
UT). The data for each channel is saved in its own subdirectory. After downloading the
data, you can use DVC to track the data without pushing the FITS files to your GitHub
repository.
...
def main():
    ...
    for channel in aia_euv_channels:
        ...
        if query_result:
            # Create a subdirectory for the channel (e.g.,
            # src/data_prep/sdo_data/aia_171)
