...
def plot_elbow_and_silhouette(data: np.ndarray, max_k: int, output_dir: str) -> tuple[int, int, str]:
    inertias = []
    silhouette_scores = []
    ...
    ax2.axvline(silhouette_best_k, color="green", linestyle="--", label=f"Silhouette Best k={silhouette_best_k}")
